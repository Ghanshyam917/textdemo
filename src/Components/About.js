...
{/* <button type="button" class="btn btn-primary mx-1 my-2" onClick={ChangeMode}>Enable {text} Mode</button> */}
{/* <button type="button" class="btn btn-primary mx-1 my-2">Enable Dark Mode</button> */}
    </div>
  )
}
